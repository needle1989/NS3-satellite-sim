...
//tracing
   ...
   std::string prefix_file_name = "TcpHybla";
     if (tracing)
    {
      ...
      Simulator::Schedule (Seconds (1), &TraceCwnd, prefix_file_name + "-cwnd.data");
      Simulator::Schedule (Seconds (1), &TraceSsThresh, prefix_file_name + "-ssth.data");
      Simulator::Schedule (Seconds (1), &TraceRtt, prefix_file_name + "-rtt.data");
      Simulator::Schedule (Seconds (1), &TraceRto, prefix_file_name + "-rto.data");
      Simulator::Schedule (Seconds (1), &TraceNextTx, prefix_file_name + "-next-tx.data");
      Simulator::Schedule (Seconds (1), &TraceInFlight, prefix_file_name + "-inflight.data");
